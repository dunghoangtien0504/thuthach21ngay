...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fdunghoangtien0504%2Fthuthach21ngay&env=VITE_SITE_TITLE,VITE_PRICE,VITE_TELEGRAM_USERNAME,VITE_SUPPORT_EMAIL)
...
5. **Cấu Hình Linh Hoạt qua `.env`**: Cho phép dễ dàng thay đổi tiêu đề trang web, giá cả, tài khoản Telegram hỗ trợ và email liên hệ mà không cần can thiệp vào mã nguồn.
